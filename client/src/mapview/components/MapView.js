...
import SocialButtons from "../../_toRemove/sharing/SocialButtons";
    ...
    <PageLayout>
      <div>
        ...
        <MapContainer center={[35.676, 139.65]} zoom={2} scrollWheelZoom={true}>
          {" "}
          {/*center can probably be average of all markers? if not centered view on greenwich*/}
          <TileLayer attribution={attrib} url={url}></TileLayer>
          <Marker position={[35.676, 139.65]}>
            <Popup>
              Trip to Japan, 2023
              <br />
              <Link to={"/"}>{"Trip"}</Link>
