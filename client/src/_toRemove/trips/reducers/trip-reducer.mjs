...
export const tripReducer = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(upsertSingleTripAsync.pending, (state) => {
    ...
    builder
      .addCase(deleteTripByTripIdAsync.pending, (state) => {
    ...
    builder
      .addCase(deleteAllTripsAsync.pending, (state) => {
    ...
    builder
      .addCase(resetAllTripsAsync.pending, (state) => {
